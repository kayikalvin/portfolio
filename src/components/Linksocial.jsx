    ...
    <div className='hidden lg:flex flex-col top-[35%] left-0 fixed '>
      <ul>
        {links.map(({id,child,href,style,download})=>(
          <li className={'flex justify-between items-center w-40 h-14 px-4 bg-gray-800 ml-[-70px] shadow-xl shadow-cyan-500/40 hover:ml-[-10px] hover:rounded-md duration-300'+ "" + style} >

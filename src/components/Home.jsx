...
const Home = () => {
  return (
    <div name ='home' id='home' className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-700 pt-50 md:pt-20'>
        <div className='max-w-screen-lg mx-auto flex gap-40 flex-col items-center justify-center h-full px-4 md:flex-row'>
            ...
            className='rounded-3xl mx-auto w-1/2 md:w-full' />
            </div>
        </div>
